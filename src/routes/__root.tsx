...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dr. Gilson Carvalho — Advocacia premium em Direito de Família, Civil, Imobiliário e Penal. OAB/TO 2.591 · OAB/RJ 256.131." },
      { property: "og:title", content: "Gilson Carvalho — Advocacia" },
      { property: "og:description", content: "Ciência jurídica avançada e advocacia sob medida." },
